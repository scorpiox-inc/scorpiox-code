...
## Systems Engineering Truth

- **Pure C99**: 93,000 lines of hand-crafted C99.
...
- **100% Local Filesystem Sessions**: Transcripts and state stored as raw, transparent JSON directly on disk.
- **Wire-Level Transparency**: Verbatim on-disk HTTP traffic recording for complete cryptographic and API auditability.
...
| **xAI Grok** | Grok Build and SuperGrok subscription authentication | [Grok Provider Guide](docs/grok-provider.md) |
| **Google Antigravity** | Gemini 2.5 and Claude Sonnet over Google Cloud Code Assist | [Antigravity Provider Guide](docs/antigravity-provider.md) |
| **OpenAI Compatible** | Direct support for local engines: llama.cpp, vLLM, SGLang, Ollama | [OpenAI Provider Guide](docs/openai-provider.md) |
